...
const animatedMessage = (text, font = 'block', colors = ['purple', 'blue'], align = 'center') => {
  cfonts.say(text, {
    font,
    align,
    gradient: colors,
...
console.clear();
animatedMessage('amane\nBot', 'block', ['blue', 'black']);
console.log('\n💣 Sistema in avvio...');
...
function start(file) {
  ...
  animatedMessage('Ediz by elking for amane', 'console', ['red', 'red']);
